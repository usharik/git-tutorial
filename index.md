...
## Скачать изменения и метки из опредлённого репозитория

Для скачивания информации из текущего репозитория введите команду
```
   git pull
```

## Отправка нашей версии репозитория на внешний репозиторий (ТРЕБУЕТ АВТОРИЗАЦИИ на внешнем репозитории)

Для отправки нашей версии репозитория на внешний репозиторий введите команду
```
   git push
```