...
Гитхаб любезно предложил использовать версию для пк, что вызвало интерес, по этому я решил ее опробовать

Как оказалось, довольно удобная штука) немного нагляднее в какой ветке находишься

Для верности выполнения задания, все же было решено провести коммит и пуш через терминал. Так, как это было сделано на семинаре