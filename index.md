...
## Перенос репозитория с github  и merge c вашей веткой

Для скачивания из репозитория на github необходимо ввести команду:

```
Git pull
```

## Скачивание репозитория на github

Для отправки вашей версии репозитория на внешний репозиторий необходимо ввести команду:
