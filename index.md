...
## Перенос изменений из локального репозитория в удаленный

Для переноса изменений из локального репозитория в удаленный используется команда
```
git push
```

## Копирование чужого репозитория на свою страницу в Github

Для создания копии чужого репозитория на своей странице в Github для дальнейшей работы с ним используется кнопка
```
Fork
```

## Перенос изменений из удаленного репозитория в локальный

Для переноса изменений из удаленного репозитория в локальный используется команда
```
git pull
```
